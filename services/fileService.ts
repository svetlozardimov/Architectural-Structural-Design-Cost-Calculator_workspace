...
import { FormState, StructuralFormState, CalculationResult, SavedProject } from '../types';
...
export const printOffer = (formState: StructuralFormState, result: CalculationResult): void => {
