...
interface SidebarProps {
  formState: any; // Generic
  savedProjects: SavedProject[];
  workspaceName: string;
  setWorkspaceName: (name: string) => void;
  currentProjectId: string | null;
  notification: string | null;
  onInputChange: (id: any, value: any) => void;
  onNewProject: () => void;
  ...
  children?: React.ReactNode; // For specific settings
}
                                ...
                                <div className="flex items-center gap-2 overflow-hidden">
                                    ...
                                    <div className="overflow-hidden">
                                        ...
                                        <p className="text-xs text-bunker-400 dark:text-bunker-500">
                                            {formatDate(project.lastModified)} <span className="ml-1 opacity-50">({project.type === 'architectural' ? 'АРХ' : 'СК'})</span>
                                        </p>
                                    </div>
                                </div>
          ...
          <div className="space-y-3">
             ...
             <div className="grid grid-cols-2 gap-2">
                 <Button onClick={onClearCurrentForm} variant="secondary" className="text-xs" title="Изчисти само полетата на формата">
                    <XIcon className="h-4 w-4 mr-1" /> Изчисти
                </Button>
